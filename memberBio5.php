...
?>
    ...
    <form id="form" method="post">
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input
              type="text"
              id="course"
              placeholder="Course eg. BSc. Information Tectnology Education"
              required
            />
          </div>
      ...
      <div class="form-group">
        <div class="col w-100">
          <label style="float: left" for="course"
            >Which region gave You study leave?</label
          >
        </div>
        <br />
        <div class="input-group">
      ...
      <div class="form-group">
        <div class="col w-100">
          <label style="float: left" for="course"
            >In which year did you get admission?</label
          >
        </div>
        <br />
        <div class="input-group">
      ...
      <div class="form-group">
        <div class="col w-100">
          <label style="float: left" for="course"
            >In which year will you complete the course?</label
          >
        </div>
        <br />
        <div class="input-group">
