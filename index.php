...
<html lang="en">
  ...
  <body>
    <!-- NAV BAR BEGINS-->
    <nav
      class="navbar navbar-expand-md navbar-expand-lg py-3 navbar-dark bg-dark navbar-expand-lg"
    >
      <div class="container">
        <button
    ...
    <div class="footer">
      <p>
        ...
        <br />
        <span style="align-items: left; text-align: left"
          >Powered by: AECleanCodes: 0549822202
        </span>
      </p>
    </div>
