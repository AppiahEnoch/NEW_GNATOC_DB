...
<body>
  ...
  <form id="form">
    <div class="form-outline mb-2 text-center m-1">
      ...
      <div class="form-group">
        <div class="col w-100">
          <label style="float: left" for="passport">Upload Passport Picture(png/jpg)</label>
        </div>
        <br />
        <div class="input-group">
          ...
          accept="image/png, image/jpeg" id="passport" name="passport"
    ...
    <div class="form-group">
      <div class="col w-100">
        ...
        for="matricula">Matricula Page (PDF only)</label>
      </div>
      <br />
      <div class="input-group">
        <div class="input-group-addon">
  ...
  <div id="aeMdImageShow" class="modal" tabindex="-1">
    <div class="modal-dialog">
      <div class="col">
        <button data-bs-dismiss="modal" class="btn btn-primary align-baseline">

        </button>
      </div>
      <div class="modal-content">
        <img style="border-radius: 50%" id="largeImage" src="devImage/user2.png" alt="" width="300" />
