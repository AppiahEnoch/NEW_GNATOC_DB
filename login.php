  ...
  <form id="form" method="post">
    ...
    <div class="form-group">
      ...
      <div class="input-group" id="password">
        ...
        <span>
          <a id="sp" href="">
            <i id="eyeID" class="fa fa-eye-slash" aria-hidden="true"></i></a>
        </span>
      </div>
    </div>
    ...
    <span>
      <br />
      <br />
      <a style="margin-right: 2rem; color: white" href="memberBio1.html
            ">New Gnatoc Member</a>
      <br />

      <a id="forgotPassword" style="color: white; font-style: italic" href="#">Forgot Password</a>
      <br />
      <a style="color: white; font-style: italic" href="index.php">Go Home</a>
      <br />
    </span>

    <span style="visibility: hidden" id="invalid" class="errorString">Inavlid Login Details
      <span>
        <i style="font-size: 2rem" class="bi bi-exclamation-triangle-fill"></i></span>
    </span>
  </form>
  <!-- partial -->
